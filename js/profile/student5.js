 // For Firebase JS SDK v7.20.0 and later, measurementId is optional
    ...
    async function getData() {
      ...
      const dosen = await db.collection("semester3").get();
    ...
    // TOTAL MAHASISWA
    function totalMhs() {
      db.collection('semester3').get().then(querySnapshot => {
    ...
    function mhsPerempuan() {
      db.collection('semester3').where('kelamin', 'in', ['perempuan']).get().then(querySnapshot => {
