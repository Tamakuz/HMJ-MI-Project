 // For Firebase JS SDK v7.20.0 and later, measurementId is optional
    ...
    async function getData() {
      ...
      const dosen = await db.collection("semester1").get();
    ...
    // TOTAL MAHASISWA
    function totalMhs() {
      db.collection('semester1').get().then(querySnapshot => {
    ...
    function mhsLaki() {
      db.collection('semester1').where('kelamin', 'in', ['Laki - laki']).get().then(querySnapshot => {
    ...
    function mhsPerempuan() {
      db.collection('semester1').where('kelamin', 'in', ['perempuan']).get().then(querySnapshot => {
